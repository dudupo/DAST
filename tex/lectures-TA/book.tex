...
\newpage\section{Graphs  - Recitation 9} 
...
\newpage\section{Union Find - Recitation 11} 
...
Could we done even better? Yes, Consider a nonunifom parttion $ B_{r} = \{ r , r+ 1 ... 2^{r} \} $. So first qustion one should ask what is $ |\mathcal{B}|$ ? 
