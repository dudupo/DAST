...
\begin{example}
  Consider a dice rolling, each of the faces, indexed by $1,2,3,4,5,6$ has the same chances to rolled out. Thus, our atomic events associated with the rolling result, and $P$ defined to be $P(\omega) = \frac{1}{6}$ for any such atomic event. 
\end{example}
