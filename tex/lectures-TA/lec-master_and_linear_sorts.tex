...
\begin{enumerate}
    ...
    \item \( T(n) = \TT{3}{4} + n\log n \rightarrow f(n) = \Omega( n^{\log_{4}(3) + \varepsilon}  ) \) and notice that \( af( \frac{n}{b}) = \frac{3n}{4}\log(\frac{n}{4})\) . Thus, it's matching the third case. \(\Rightarrow T(n) = \Theta(n\log n)\).
