...
\begin{example} \textbf{Problem} Assume that input is array consists of only $0$'s and $1$'s. For example: \begin{equation*}
    \begin{split}
  A = 0,1,1,1,0,0,1,0,1
    \end{split}
  \end{equation*}
  Write an algorithm that sort given the assumption.
