...
\hline
\textbf{Data Structure} & \textbf{Access} & \textbf{Max/min} & \textbf{Insert/Delete} & \textbf{Max/min}  \\ 
Array                   & Data 2          & Data 3           & Data 3                 & Data 3          \\ 
Linked-List             & $O(n)$          & $O(n)$           & $O(1)$                 & Data 6          \\ 
Heap                    & $O(n)$          & $O(\log n)$      & $O(\log n) $           & Data 9          \\ 
Hash Table              & $O(n)$          & $O( )$           & $O( )$                 & Data 9          \\ 
\end{tabularx}
