...
\begin{equation*}
  \begin{split}
    ...
    & = 1 + \log \left( \left( 1+ \frac{200}{n-100} \right)^{ \lfloor \frac{n}{2} \rfloor } \right) \le 1 + \lim_{n \rightarrow \infty} \log \left( \left( 1+ \frac{200}{n-100} \right)^{ \lfloor \frac{n}{2} \rfloor } \right) 1  + e^{200}  \\ 
     \end{split}
\end{equation*}
