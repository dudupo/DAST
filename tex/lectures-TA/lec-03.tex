...
\paragraph{Task: Extracting Heap's Minimum.} \textit{Let $H$ be an Heap at size $n$, Write algorithm which return $H_1$ and $H^\prime$ Heap which contain all the elemenets of $H / H_1 $. } 
