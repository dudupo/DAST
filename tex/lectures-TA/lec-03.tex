...
\begin{equation*}
  \begin{split}
    ...
    T\left( n + 1 \right) - T\left( n \right) & \le \log\left( \lfloor \frac{n+1}{ \frac{n+1}{2}  }  \rfloor  \right) + \sum{ \log \left( \lfloor \frac{n+1}{i} \rfloor \left( \lfloor \frac{n}{i} \rfloor \right)^{-1}  \right)  } \le  \log\left( 2  \right) + \sum{ \log \left( \frac{n+100}{i}  \frac{i}{n-100}   \right)  } \le \\ 
