...
\end{algorithm}
\end{algbox}
\paragraph{Claim.} Assume that $H$ satisfiey the Heap inquality for all the elements except $H_{1}$. Namely for any $i > 1$ we have that $H_{i} \le H_{2i}, H_{2i+1}$. Then applying Heapify-down on $H$ retuens an heap. 
\paragraph{Proof.}
