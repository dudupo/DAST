...
\begin{equation*}
  \begin{split}
    ...
    T\left( n + 1 \right) - T\left( n \right) & \le \log\left( \frac{n+1}{ \lfloor \frac{n+1}{2} \rfloor } \right) + \sum{ \log \left( \lfloor \frac{n+1}{i} \rfloor \lfloor \frac{i}{n} \rfloor  \right)  } \le \\ 
