...
\begin{equation*}
  \begin{split}
    ...
    T\left( n + 1 \right) - T\left( n \right) & \le \log\left( \lfloor \frac{n+1}{ \frac{n+1}{2}  }  \rfloor  \right) + \sum{ \log \left( \lfloor \frac{n+1}{i} \rfloor \left( \lfloor \frac{n}{i} \rfloor \right)^{-1}  \right)  } \le \\ 
   &  \log\left( 2  \right) + \sum{ \log \left( \frac{n+100}{i}  \frac{i}{n-100}   \right)  } \le \\ 
    &  \log\left( 2  \right) + \sum{ \log \left( 1+ \frac{200}{n-100} \right)  } = 
    \log\left( 2  \right) + \sum{ \log \left( 1+ \frac{200}{n-100} \right)  } \le \\
    & \log\left( 2  \right) + \log \left( \left( 1+ \frac{200}{n-100} \right)^{ \lfloor \frac{n}{2} \rfloor } \right) \le \\ &   \log\left( 2 \right)  + e^{200} \le \\ 
    \left( n \right) &= \Theta\left(  n  \right) 
  \end{split}
\end{equation*}
