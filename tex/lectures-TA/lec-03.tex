...
\begin{defbox}{Heap}
  Consider the sequance $H = H_{1}, H_{2} \cdots H_{n} \in \mathbb{R} \left( * \right)$. we will csay that $H$ is a Heap if for every $i \in [n]$ we have that: $H_{i} \le H_{2i}, H_{2i + 1}$ when we think of the value at indecis greater than $n$ as $H_{i>n} = -\infty$. 
\end{defbox}
