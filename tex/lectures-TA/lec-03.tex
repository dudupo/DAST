...
\paragraph{Task: The Superpharm Line.} \textit{ You are requested to maintain a pharmacy line, in each turn you get one of the fallowing queries, etheir a new customer enter into the shop, ethir apharmacist request for the person stand in front.    }
