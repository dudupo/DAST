...
\subparagraph{Claim.} If $a \in X$ is smaller than $i$ elements of $X$ and $b \in Y$ is smaller than $j$ elemnts of $Y$. Then, $a + b$ is smaller than $i\cdot j$ elements of $X \oplus Y$.
\input{../texlib/tail}
