...
\begin{equation*}
  \begin{split}
    ...
    T\left( n + 1 \right) - T\left( n \right) & \le \log\left( \lfloor \frac{n+1}{ \frac{n+1}{2}  }  \rfloor  \right) + \sum{ \log \left( \lfloor \frac{n+1}{i} \rfloor \left( \lfloor \frac{n}{i} \rfloor \right)^{-1}  \right)  } \\  & \le  \log\left( 2  \right) + \sum{ \log \left( \frac{n+100}{i}  \frac{i}{n-100}   \right)  } \le  1  + \sum{ \log \left( 1+ \frac{200}{n-100} \right)  } \\ 
    & = 1 + \log \left( \left( 1+ \frac{200}{n-100} \right)^{ \lfloor \frac{n}{2} \rfloor } \right) \le 1 + \lim_{n \rightarrow \infty} \le  \log \left( \left( 1+ \frac{200}{n-100} \right)^{ \lfloor \frac{n}{2} \rfloor } \right) 1  + e^{200}  \\ 
     \end{split}
\end{equation*}
