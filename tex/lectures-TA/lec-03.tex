...
\paragraph{Task: The Superpharm Line.} \textit{ You are requested to maintain a pharmacy line, in each turn you get one of the fallowing queries, etheir a new customer enter into the shop, ethir apharmacist request for the next person stand in front. In addtion you are requested to provide priority fredom degree.}
Naive soultion? 
