...
\paragraph{Task:}. Write a datastructure that support insertion and deltion at $O\left( \log n \right) $ time and in addition enable to query the median in $O\left( \log n  \right)$ time. 
