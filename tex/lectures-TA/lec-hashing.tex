...
\begin{solution}
  \begin{equation*}
    ...
    \end{split}
  \end{equation*}
  So, the hashing is equivalence to flattening $ A $ into an $ n \times n $ binary vector and then multiplying it by a randomly chosen vector. Which was proved in \Cref{example:vec} to be a $2$-universal. 
\end{solution}
