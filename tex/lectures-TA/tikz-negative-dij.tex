...
\begin{tikzpicture}%[ultra thick]
  \node [every  neuron ] (v-1) at ( 3 ,-0) { $s$ } ;
  \node [every  neuron ] (v-2) at ( 1 ,-1.5) { } ;
  \node [every  neuron ] (v-3) at ( 5 ,-1.5) { } ;
  \node [every  neuron ] (v-4) at ( 3 ,-5) { $t$ } ;
...
%\node  (v-9) at ( 7 ,-7) { $\vdots$  };
  \draw [->] (v-1) -- (v-2) node[midway,above]() { $1$ };
  \draw [->] (v-1) -- (v-3) node[midway,above]() { $2 $} ;
  \draw [->] (v-2) -- (v-4) node[midway,above]()  { $0$ };
  \draw [->] (v-3) -- (v-4) node[midway,above]() { $-10$ };
%%  node[right=6pt] {$y$} at
