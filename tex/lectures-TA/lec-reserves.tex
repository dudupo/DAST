...
Another sorting algorithms, that it's correctness isn't so obivoius. The following alogrithm were developed by Stanley P. Y. Fung, \cite{Simplesort} whose coined it's name-''ICan’tBelieveItCanSort'' for the unclirity.  
