...
\begin{tikzpicture}
    ...
    \draw[domain=5:7,smooth,variable=\x,blue,name path=c2] plot ({\x},{ \x-4.5});
    \draw[domain=7:9,smooth,variable=\x,blue,name path=c2] plot ({\x},{ 2-(\x-6.5)})node[right]{$2$};
    \draw[domain=10:14,smooth,variable=\x,blue,name path=c2] plot ({\x},{\x-9})node[right]{$3$};
