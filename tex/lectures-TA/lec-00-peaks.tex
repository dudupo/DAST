...
\begin{tikzpicture}
    ...
    \draw[domain=4.5:6.5,smooth,variable=\x,blue,name path=c2] plot ({\x},{ \x-4.5});
    \draw[domain=6.5:8.5,smooth,variable=\x,blue,name path=c2] plot ({\x},{ 2-(\x-6.5)})node[right]{$f_2(n)$};
    \draw[domain=9:13,smooth,variable=\x,blue,name path=c2] plot ({\x},{\x-9})node[right]{$f_2(n)$};
