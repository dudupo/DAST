...
\begin{itemize}
  \item  if p ≤ k ≤ i, then A[k] ≤ x (the tan region of Figure 7.2);
  \item  if i + 1 ≤ k ≤ j – 1, then A[k] > x (the blue region);
