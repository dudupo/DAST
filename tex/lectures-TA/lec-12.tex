...
For example conisder our last calculation, In which we divided the ranges of ranks into $\log n$ buckets and then  
\begin{equation*}
  \begin{split}
  \sum_{ B \in \mathcal{B} }{ \frac{n}{\min{B} } |B| } \le \sum_{ B \in \{ [i] | i \in [ \log n ]  \}  }{ x  } 
  \end{split}
\end{equation*}
