...
Please write a tikz code of a computation tree, each node contain an array, the recursive call split the array into two unbalacend parts, the left son will always get a 1/3 of the array while the right get 2/3 of it. please draw at least 3 levels. I'm intersting only in the length of the arrays, so please use an empty rectangles to present them, without setting values to their elements. 
\begin{tikzpicture}[level/.style={sibling distance=4cm/#1, level distance=1.5cm}]
\node [rectangle, draw] (root) {};
\node [rectangle, draw, below left=of root] (left1) {};
\node [rectangle, draw, below right=of root] (right1) {};
\node [rectangle, draw, below left=of left1] (left2) {};
\node [rectangle, draw, below right=of left1] (right2) {};
\node [rectangle, draw, below left=of right1] (left3) {};
\node [rectangle, draw, below right=of right1] (right3) {};
...
\node [below=0.5cm of left1] {1/3};
\node [below=0.5cm of right1] {2/3};
\node [below=0.5cm of left2] {1/9};
\node [below=0.5cm of right2] {2/9};
\node [below=0.5cm of left3] {2/9};
\node [below=0.5cm of right3] {4/9};
\end{tikzpicture}
