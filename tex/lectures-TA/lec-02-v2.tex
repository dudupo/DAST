...
\begin{tikzpicture}[level distance=1.5cm,
 ...
 \node [rectangle, minimum width=0.4cm, minimum height=0.2cm, below left   of=root,   xshift=-0.2cm,  draw] (left1)  {};
 \node [rectangle, minimum width=0.8cm, minimum height=0.2cm, below right  of=root,   xshift=0.2cm,   draw] (right1) {};
 \node [rectangle, minimum width=0.2cm, minimum height=0.2cm, below left   of=left1,  xshift=-0.1cm,  draw] (left2)  {};
 \node [rectangle, minimum width=0.2cm, minimum height=0.2cm, below right  of=left1,  xshift=0.1cm,   draw] (right2) {};
 \node [rectangle, minimum width=0.4cm, minimum height=0.2cm, below left   of=right1, xshift=-0.2cm,  draw] (left3)  {};
 \node [rectangle, minimum width=0.4cm, minimum height=0.2cm, below right  of=right1, xshift=0.2cm,   draw] (right3) {};
