...
\begin{tikzpicture}[level distance=1.5cm,
  ...
  child {
    node [rectangle, minimum width=3cm, minimum height=1cm, draw] (left1) {}
    child {
      node [rectangle, minimum width=1.5cm, minimum height=1cm, draw] (left2) {}
      child {
        node [rectangle, minimum width=0.75cm, minimum height=1cm, draw] (left3) {}
      }
      child {
        node [rectangle, minimum width=0.75cm, minimum height=1cm, draw] (right3) {}
      }
    }
    child {
      node [rectangle, minimum width=1.5cm, minimum height=1cm, draw] (right2) {}
      child {
        node [rectangle, minimum width=0.75cm, minimum height=1cm, draw] (left3) {}
      }
      child {
  ...
  child {
    node [rectangle, minimum width=3cm, minimum height=1cm, draw] (right1) {}
    child {
      node [rectangle, minimum width=1.5cm, minimum height=1cm, draw] (left2) {}
      child {
        node [rectangle, minimum width=0.75cm, minimum height=1cm, draw] (left3) {}
