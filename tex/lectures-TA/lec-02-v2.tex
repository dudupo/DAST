...
\begin{tikzpicture}[level distance=1.5cm,
  ...
  \node [rectangle, minimum width=6cm, minimum height=1cm, draw] (root) {};
  \node [rectangle, minimum width=2cm, minimum height=1cm, below left of=root, xshift=-1cm, draw] (left1) {};
  \node [rectangle, minimum width=4cm, minimum height=1cm, below right of=root, xshift=1cm, draw] (right1) {};
  \node [rectangle, minimum width=1cm, minimum height=1cm, below left of=left1, xshift=-0.5cm, draw] (left2) {};
  \node [rectangle, minimum width=1cm, minimum height=1cm, below right of=left1, xshift=0.5cm, draw] (right2) {};
  \node [rectangle, minimum width=2cm, minimum height=1cm, below left of=right1, xshift=-1cm, draw] (left3) {};
  \node [rectangle, minimum width=2cm, minimum height=1cm, below right of=right1, xshift=1cm, draw] (right3) {};
  \node [rectangle, minimum width=0.5cm, minimum height=1cm, below left of=left2, xshift=-0.25cm, draw] (left4) {};
  \node [rectangle, minimum width=0.5cm, minimum height=1cm, below right of=left2, xshift=0.25cm, draw] (right4) {};
  \node [rectangle, minimum width=0.5cm, minimum height=1cm, below left of=right2, xshift=-0.25cm, draw] (left5) {};
  \node [rectangle, minimum width=0.5cm, minimum height=1cm, below right of=right2, xshift=0.25cm, draw] (right5) {};
  \node [rectangle, minimum width=1cm, minimum height=1cm, below left of=left3, xshift=-0.5cm, draw] (left6) {};
  \node [rectangle, minimum width=1cm, minimum height=1cm, below right of=left3, xshift=0.5cm, draw] (right6) {};
  \node [rectangle, minimum width=1cm, minimum height=1cm, below left of=right3, xshift=-0.5cm, draw] (left7) {};
  \node [rectangle, minimum width=1cm, minimum height=1cm, below right of=right3, xshift=0.5cm, draw] (right7) {};
...
\begin{tikzpicture}[level distance=1.5cm,
  ...
  level 2/.style={sibling distance=3cm}]
  \node [rectangle, minimum width=6cm, minimum height=1cm, draw] (root) {};
  \node [rectangle, minimum width=1cm, minimum height=1cm, below left of=root, xshift=-2cm, draw] (left1) {};
  \node [rectangle, minimum width=5cm, minimum height=1cm, below right of=root, xshift=2cm, draw] (right1) {};
  \node [rectangle, minimum width=1cm, minimum height=1cm, below left of=left1, xshift=-1cm, draw] (left2) {};
  \node [rectangle, minimum width=4cm, minimum height=1cm, below right of=left1, xshift=1cm, draw] (right2) {};
  \node [rectangle, minimum width=1cm, minimum height=1cm, below left of=right1, xshift=-1cm, draw] (left3) {};
  \node [rectangle, minimum width=4cm, minimum height=1cm, below right of=right1, xshift=1cm, draw] (right3) {};
  \draw (root) -- (left1);
  \draw (root) -- (right1);
  \draw (left1) -- (left2);
  \draw (left1) -- (right2);
...
This computation tree can continue to grow in depth, with each level representing a further split of the array into smaller and smaller parts. The empty rectangles in each node represent the length of the array, with the width of the rectangle proportional to the number of elements in the array. This allows for a visual representation of the unbalanced split of the array, with the right child node always receiving a larger portion of the array compared to the left child node. 
	...
	% left child
	\node[rectangle, minimum width=0.6cm, minimum height=1cm, below left of=root, draw] (left) {};
	\node[rectangle, minimum width=5.4cm, minimum height=1cm, below right of=root, draw] (right) {};
	
	% left child's children
	\node[rectangle, minimum width=0.06cm, minimum height=1cm, below left of=left, draw] (left1) {};
	\node[rectangle, minimum width=0.54cm, minimum height=1cm, below right of=left, draw] (right1) {};
	
	% right child's children
	\node[rectangle, minimum width=4.86cm, minimum height=1cm, below left of=right, draw] (left2) {};
	\node[rectangle, minimum width=0.54cm, minimum height=1cm, below right of=right, draw] (right2) {};
	
	% labels
%	\node[below of=root, yshift=-0.5cm] {Array of length 10};
%	\node[below of=left, yshift=-0.5cm] {Array of length 1};
%	\node[below of=right, yshift=-0.5cm] {Array of length 9};
%	\node[below of=left1, yshift=-0.5cm] {Empty rectangle};
%	\node[below of=right1, yshift=-0.5cm] {Empty rectangle};
%	\node[below of=left2, yshift=-0.5cm] {Array of length 9};
%	\node[below of=right2, yshift=-0.5cm] {Empty rectangle};
%	
	\end{tikzpicture}
	
	\begin{tikzpicture}[level/.style={sibling distance=4cm/#1, level distance=1.5cm}]
		\node [rectangle, minimum width=4cm, minimum height=1cm, draw] (root) {};
		\node [rectangle, minimum width=1cm, minimum height=1cm, below left of=root, xshift=-2cm, draw] (left) {};
		\node [rectangle, minimum width=3cm, minimum height=1cm, below right of=root, xshift=2cm, draw] (right) {};
		\node [rectangle, minimum width=0.3cm, minimum height=1cm, below left of=left, xshift=-0.5cm, draw] (left1) {};
		\node [rectangle, minimum width=0.7cm, minimum height=1cm, below right of=left, xshift=0.5cm, draw] (right1) {};
		\node [rectangle, minimum width=2.7cm, minimum height=1cm, below right of=right, xshift=0.5cm, draw] (right2) {};
