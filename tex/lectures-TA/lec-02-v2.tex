...
\begin{tikzpicture}[level distance=1.5cm,
  ...
  child {
    node [rectangle, minimum width=3cm, minimum height=1cm] (left1) {}
    child {
      node [rectangle, minimum width=1.5cm, minimum height=1cm] (left2) {}
      child {
        node [rectangle, minimum width=0.75cm, minimum height=1cm] (left3) {}
      }
      child {
        node [rectangle, minimum width=0.75cm, minimum height=1cm] (right3) {}
      }
    }
    child {
      node [rectangle, minimum width=1.5cm, minimum height=1cm] (right2) {}
      child {
        node [rectangle, minimum width=0.75cm, minimum height=1cm] (left3) {}
      }
      child {
  ...
  child {
    node [rectangle, minimum width=3cm, minimum height=1cm] (right1) {}
    child {
      node [rectangle, minimum width=1.5cm, minimum height=1cm] (left2) {}
      child {
        node [rectangle, minimum width=0.75cm, minimum height=1cm] (left3) {}
